...
class ListServices 
{
	...
	//isDateExists..
	public function isDateExists($epochTime)
	{
		return ListModels::isDateExists($epochTime);
	}

	//findGivenID
	public function findGivenID($epochTime)
	{
		return ListModels::findGivenID($epochTime);
	}

	//findSubtypeID
	public function findSubtypeID($epochTime)
	{
		return ListModels::findSubtypeID($epochTime);
	}

	//totalServieTime
	public function totalServieTime($epochTime)
	{
		return ListModels::totalServieTime($epochTime);
	}
